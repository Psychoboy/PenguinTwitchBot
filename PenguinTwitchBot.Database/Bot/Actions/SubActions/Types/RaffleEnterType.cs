...
{
    [SubActionMetadata(
        displayName: "Raffle Enter",
        description: "Add the current command user to a running raffle",
        icon: "mdi-cog",
        color: "Success",
        tableName: "subactions_raffleenter")]
    public class RaffleEnterType : SubActionType, ISubActionUIProvider
    {
        public RaffleEnterType() => SubActionTypes = SubActionTypes.RaffleEnter;
