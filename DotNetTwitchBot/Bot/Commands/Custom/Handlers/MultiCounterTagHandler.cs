...
{
    public class MultiCounterTagHandler(IServiceScopeFactory scopeFactory, ILogger<MultiCounterTagHandler> logger) : Application.Notifications.IRequestHandler<MultiCounterTag, CustomCommandResult>
    {
