...
namespace DotNetTwitchBot.Bot.Commands.Moderation
{
    public class BannedUsers : BaseCommandService, IHostedService
    {
        ...
        public BannedUsers(ILogger<BannedUsers> logger, IServiceScopeFactory scopeFactory, IServiceBackbone serviceBackbone, ICommandHandler commandHandler, ITwitchService twitchService, IPenguinDispatcher mediator) : 
