...
namespace DotNetTwitchBot.Bot.Commands.Misc
{
    public class DailyCounter : BaseCommandService, IHostedService
    {
        ...
        public DailyCounter(
            ...
            ) : base(serviceBackbone, commandHandler, "DailyCounter", dispatcher)
        {
        ...
        private async Task UpdateCounter()
        {
            ...
            var text = format
                .Replace("{value}", value.ToString(), StringComparison.OrdinalIgnoreCase)
                .Replace("{nextgoal}", NextValue(value).ToString(), StringComparison.OrdinalIgnoreCase);
