...
public class ViewersInChatBonusProvider : IGameSettingsFormProvider
{
    ...
    [
        ...
        {
            Title = "Payouts",
            Description = "Points awarded to each viewer tier every 15 minutes",
            ...
            [
                ...
                new() { Key = KeyActive, Label = "Points for Active/Subs", FieldType = GameSettingFieldType.Int, Min = 1, HelperText = "Bonus for active viewers and subs" },
