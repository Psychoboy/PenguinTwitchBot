...
### 1. `GiftPoints`
- Awards a specified amount of points to a designated user or event participant.
- Can award points for mini-game completions, quiz winners, raid participants, or Twitch event triggers.
