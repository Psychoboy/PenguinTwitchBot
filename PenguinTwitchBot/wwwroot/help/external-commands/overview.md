...
> [!NOTE]
> External Commands do **not** make outgoing HTTP requests or forward responses. Instead, they serve as a unified registry so that commands handled outside Penguin Twitch Bot are listed in the public viewer [Commands](/commands) page.

- **Unified Commands Directory**: Viewers visiting your channel's public [Commands](/commands) page see all available commands in one place, even if some commands are powered by external software.
