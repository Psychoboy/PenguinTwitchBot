...
- **Exporting All Themes**: Click the **Export All** button in the top toolbar to download a backup package of all active custom and preset themes.
- **Importing Themes**: Click **Import Theme** in the top toolbar. You can either upload a theme `.json` file from your device or paste raw theme JSON directly. Preview the colors and theme details, then click **Import Theme** to add it to your bot.
