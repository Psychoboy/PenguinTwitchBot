...
> [!WARNING]
> Updating queue capacities restarts the WebSocket server. All connected browser sources and dashboards will be temporarily disconnected. Clients with automatic reconnect enabled (e.g. `overlay.html`) will reconnect within 2-5 seconds.
