namespace PenguinTwitchBot.Bot.Events
{
    ...
    /// <summary>
    /// Local Power-Up model â€” not the TwitchLib type.
    ...
    /// <summary>
    /// Local bits message model â€” not the TwitchLib type.
    /// </summary>
    ...
    /// <summary>
    /// Local bits emote/fragment model â€” not the TwitchLib type.
