...
namespace PenguinTwitchBot.Bot.Core
{
    public interface IServiceBackbone
    {
        ...
        Task SendChatMessage(string message, bool sourceOnly);
        Task SendChatMessage(string name, string message);
        Task SendChatMessage(string name, string message, bool sourceOnly);
        Task SendChatMessageWithTitle(string viewerName, string message);
        Task SendChatMessageWithTitle(string viewerName, string message, bool sourceOnly);
        ...
        Task ResponseWithMessage(CommandEventArgs e, string message, bool sourceOnly);
    }
}