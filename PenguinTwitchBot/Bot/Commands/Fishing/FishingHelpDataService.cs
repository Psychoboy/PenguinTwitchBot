...
namespace PenguinTwitchBot.Bot.Commands.Fishing
{
    ...
    public class FishingHelpDataService : IFishingHelpDataService
    {
        ...
        private RarityGuideSection BuildRarityGuideSection(List<FishingShopItem> shopItems, FishingSettings? settings)
        {
            ...
            {
                BaselinePercentages = FishingRarityWeightProfiles.CreateBaseWeights(),
        ...
        private GoldSection BuildGoldSection()
        {
            ...
            {
                { 3, "1.25 to 1.41x gold multiplier (3-star)" },
                { 2, "1.0 to 1.25x gold multiplier (2-star)" },
                { 1, "0.75 to 1.0x gold multiplier (1-star)" }
            };
