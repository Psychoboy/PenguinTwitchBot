        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RandomAction = table.Column<bool>(type: "boolean", nullable: false),
                    ConcurrentAction = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastShoutout = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AutoPlayClip = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextGlobalCooldownTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NextUserCooldownTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CommandName = table.Column<string>(type: "text", nullable: false),
                    UserName = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoostMode = table.Column<bool>(type: "boolean", nullable: false),
                    BoostModeRarityMultiplier = table.Column<double>(type: "double precision", nullable: false),
                    LineSnapChance = table.Column<double>(type: "double precision", nullable: false),
                    RodSnapChance = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username = table.Column<string>(type: "text", nullable: false),
                    SnapType = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    TotalGoldLost = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    LostItemCount = table.Column<int>(type: "integer", nullable: false),
                    LostItemsJson = table.Column<string>(type: "text", nullable: false),
                    SnappedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingBoolValue = table.Column<bool>(type: "boolean", nullable: false),
                    SettingDoubleValue = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Username = table.Column<string>(type: "text", nullable: false),
                    ExpireDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Username = table.Column<string>(type: "text", nullable: false),
                    WinningDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDisconnected = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastIncomingRaid = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastOutgoingRaid = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastCheckOnline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoubleSetting = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Username = table.Column<string>(type: "text", nullable: false),
                    LastSub = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isMod = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermaBan = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    ExcludeRegulars = table.Column<bool>(type: "boolean", nullable: false),
                    ExcludeSubscribers = table.Column<bool>(type: "boolean", nullable: false),
                    ExcludeVips = table.Column<bool>(type: "boolean", nullable: false),
                    Message = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubActionTypes = table.Column<int>(type: "integer", nullable: false),
                    ActionTypeId = table.Column<int>(type: "integer", nullable: true),
                    EnablePoint = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionTypeId = table.Column<int>(type: "integer", nullable: true),
                    CommandName = table.Column<string>(type: "text", nullable: false),
                    ElevatedCommand = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RespondToChat = table.Column<bool>(type: "boolean", nullable: false),
                    ElevatedCommand = table.Column<bool>(type: "boolean", nullable: false),
                    RankToExecuteAs = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubActionTypes = table.Column<int>(type: "integer", nullable: false),
                    ActionTypeId = table.Column<int>(type: "integer", nullable: true),
                    UseBot = table.Column<bool>(type: "boolean", nullable: false),
                    FallBack = table.Column<bool>(type: "boolean", nullable: false),
                    StreamOnly = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubActionTypes = table.Column<int>(type: "integer", nullable: false),
                    ActionTypeId = table.Column<int>(type: "integer", nullable: true),
                    Append = table.Column<bool>(type: "boolean", nullable: false),
                    File = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoostAmount = table.Column<double>(type: "double precision", nullable: false),
                    BoostType2 = table.Column<int>(type: "integer", nullable: true),
                    BoostAmount2 = table.Column<double>(type: "double precision", nullable: true),
                    BoostType3 = table.Column<int>(type: "integer", nullable: true),
                    BoostAmount3 = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SayCooldown = table.Column<bool>(type: "boolean", nullable: false),
                    SayRankRequirement = table.Column<bool>(type: "boolean", nullable: false),
                    ExcludeFromUi = table.Column<bool>(type: "boolean", nullable: false),
                    SourceOnly = table.Column<bool>(type: "boolean", nullable: false),
                    Category = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    SpecificUserOnly = table.Column<string>(type: "text", nullable: true),
                    SpecificUsersOnly = table.Column<List<string>>(type: "text[]", nullable: false),
                    SpecificRanks = table.Column<int[]>(type: "integer[]", nullable: false)
                },
                constraints: table =>
                {
