...
namespace PenguinTwitchBot.Migrations.Postgres;
...
public sealed class PostgresDesignTimeDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
{
	public ApplicationDbContext CreateDbContext(string[] args)
	{
		...
		var connectionString = config.GetConnectionString("PostgresConnection")
			?? Environment.GetEnvironmentVariable("PenguinTwitchBot_POSTGRES_CONNECTION")
			?? "Host=localhost;Database=PenguinTwitchBot;Username=postgres;Password=Password;";
