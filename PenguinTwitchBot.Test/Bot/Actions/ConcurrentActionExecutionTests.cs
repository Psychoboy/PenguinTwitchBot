...
namespace PenguinTwitchBot.Test.Bot.Actions
{
    public class ConcurrentActionExecutionTests
    {
        ...
        public async Task ConcurrentAction_WithLogging_ShouldNotThrowExceptions()
        {
            ...
            // Add logging
            services.AddSingleton<ILogger<PenguinTwitchBot.Bot.Actions.Action>>(Substitute.For<ILogger<PenguinTwitchBot.Bot.Actions.Action>>());
            ...
            var hubContext = Substitute.For<Microsoft.AspNetCore.SignalR.IHubContext<PenguinTwitchBot.Bot.Hubs.MainHub>>();
            ...
            var action = new PenguinTwitchBot.Bot.Actions.Action(
                serviceProvider.GetRequiredService<ILogger<PenguinTwitchBot.Bot.Actions.Action>>(),
                scopeFactory,
                serviceBackbone);
