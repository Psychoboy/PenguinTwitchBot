...
namespace PenguinTwitchBot.Test.Bot.Actions
{
    ...
    {
        private readonly ILogger<PenguinTwitchBot.Bot.Actions.Action> logger;
        ...
        private readonly PenguinTwitchBot.Bot.Actions.Action action;
        private readonly ConcurrentDictionary<string, string> variables;

        public ActionTests()
        {
            logger = Substitute.For<ILogger<PenguinTwitchBot.Bot.Actions.Action>>();
            ...
            action = new PenguinTwitchBot.Bot.Actions.Action(logger, scopeFactory, serviceBackbone);
