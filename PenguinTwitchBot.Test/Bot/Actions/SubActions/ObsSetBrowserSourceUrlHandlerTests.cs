...
{
    public class ObsSetBrowserSourceUrlHandlerTests
    {
        ...
        [Fact]
        public async Task ValidType_SetsBrowserSourceUrl()
        {
            ...
            var type = new ObsSetBrowserSourceUrlType { OBSConnectionId = 1, InputName = "Browser", Url = "https://example.com" };
        ...
        public async Task MissingConnectionId_ThrowsException()
        {
            ...
            var type = new ObsSetBrowserSourceUrlType { OBSConnectionId = null, InputName = "Browser", Url = "https://example.com" };
            var variables = new ConcurrentDictionary<string, string>();
